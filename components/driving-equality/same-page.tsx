...
export const SamePage = () => {
  ...
  const opacity = useTransform(
    ...
    [
      ...
      animationOrder.endTextFadeInEnd,
    ],
    [0, 1, 0.8, 0]
  );
    ...
    <section ref={targetRef}>
      <div className="relative h-[700vh]">
        ...
        <motion.div
          ...
          className="left-1/2 -translate-x-1/2 top-0 h-full w-full max-w-[1132px] text-2xl leading-tight text-white"
        >
          <motion.p
